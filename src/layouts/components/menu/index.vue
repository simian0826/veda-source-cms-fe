...
export default defineComponent({
  ...
  setup(props) {
    ...
    const getIsShowFilter = computed(() => unref(getShowFilter));
    ...
    const getWrapperStyle = computed((): CSSProperties => {
      return {
        height: `calc(100vh - ${unref(getIsShowLogo) ? "96px" : "0px"})`,
        // overflowX: "hidden",
        overflowY: "auto",
      };
    });
    ...
    function renderMenu() {
      ...
      return (
        <div style={unref(getWrapperStyle)}>
          ...
          <BasicMenu
            ...
            showFilter={unref(getIsShowFilter)}
