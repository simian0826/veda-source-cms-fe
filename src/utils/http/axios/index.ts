...
const transform: AxiosTransform = {
   ...
   */
  transformRequestHook: async (
    res: AxiosResponse<Gen2Result | BlobPart>,
    ...
    switch (code) {
      case ResultEnum.TIMEOUT:
        if (!isRefreshed) {
          // const previousCofig = res.config;
          const refreshTokenResult = await userStore.refreshTokenAction();
